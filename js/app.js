...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.classList.add("product", "ms-5", "shadow-lg", "mb-5", "card-style");
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h5 class="text-warning fw-bold">Rating: ${product.rating.rate}  </h5> <p  class="text-danger fw-bold"> Total Rate: ${product.rating.count}</p> 
      <h2>Price: $ ${product.price}</h2>
      <div class="d-flex justify-content-between"><button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
